...
export function CollectionBanner() {
    const buttonHeroAddClasses =  "flex flex-row justify-center items-center font-bold text-white text-[20px] gap-x-2 bg-secondary rounded-full mb-10 ml-10";
    ...
    return (
        <div className= {containerClasses}>
                    <ButtonClick height="h-[56px]" text="See More" width="w-[180px]" icon="arrowRight" iconSize="size-6" additionalClassName={buttonHeroAddClasses}/>
